...
class M_journal_posted extends CI_Model
{
	...
	public function get_where_journal_posted($param)
	{
		$this->db->select('a.*,
	...
	public function get_journal_posted_item($param)
	{
		$this->db->select('a.*,
						b.group_team,
