				...
				<div class="col-6">
					<div class="mb-3">
						...
						<input type="text" id="kode_segment" name="kode_segment" data-parsley-required="true"
							...
							value="<?= $data->code_segment ?>" class="form-control-hover-light form-control"
			...
			<div class="row">
				<div class="col-6">
					<div class="mb-3">
						...
						<input type="text" id="nama_segment" name="nama_segment" value="<?= $data->name ?>"
