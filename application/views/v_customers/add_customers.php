            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" id="name" name="name" class="form-control form-control-hover-light" placeholder="Masukkan nama customer" data-parsley-required="true" data-parsley-errors-container=".err_name">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" id="phone" name="phone" class="form-control form-control-hover-light" placeholder="Masukkan nomor telepon" data-parsley-pattern="^[0-9+ ]+$" data-parsley-minlength="8" data-parsley-errors-container=".err_phone">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="email" id="email" name="email" class="form-control form-control-hover-light" placeholder="Masukkan email customer" data-parsley-type="email" data-parsley-errors-container=".err_email">
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <textarea id="address" name="address" class="form-control form-control-hover-light" placeholder="Masukkan alamat customer" rows="2" data-parsley-errors-container=".err_address"></textarea>
    ...
    $(document).ready(function() {
        ...
        $('#btnsubmit').click(function(e) {
            ...
            if (form.parsley().isValid()) {
                $.ajax({
                    url: "<?= base_url('C_customers/simpandata') ?>",
                    type: 'POST',
                    dataType: 'JSON',
                    data: form.serialize(),
                    beforeSend: function() {
