    ...
    <div class="card-body">
        <form id="forms_add">
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                        <label class="form-label" for="depos_code">depos Code</label>
                        <input type="hidden" name="uuid" value="<?= $uuid ?>">
                        <input type="text" value="<?= $data->code_depo ?>" id="depos_code" name="depos_code"
                            class="form-control bg-soft-secondary" readonly>
                    </div>
                </div>
                <div class="col-6">
                    <div class="mb-3">
                        <label class="form-label" for="depos_name">depos Name</label>
                        <input type="text" value="<?= $data->name ?>" id="depos_name" name="depos_name"
                            class="form-control-hover-light form-control" placeholder="input depos name"
