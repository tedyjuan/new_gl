    ...
    <div class="card-body">
        <form id="forms_add">
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                        <label class="form-label" for="depos_code">Kode Perusahaan</label>
                        <input type="text" id="depos_code" name="depos_code" data-parsley-minlength="3"
                ...
                <div class="col-6">
                    <div class="mb-3">
                        <label class="form-label" for="depos_name">Nama Perusahaan</label>
                        <input type="text" id="depos_name" name="depos_name"
...
<script>
    $(document).ready(function() {
        $('#depos_code').on('input', function(e) {
