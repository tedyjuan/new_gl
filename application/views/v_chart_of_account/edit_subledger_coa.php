			...
			<div class="row">
				<div class="col-6">
					...
					<table class="table table-bordered">
						<tbody>
							<tr>
								<th style="width: 35%">ID Akun Ledger</th>
				...
				<div class="col-6 mt-1">
					<div class="mb-3">
						...
						<div class="input-group mb-3">
							<input type="text" class="form-control bg-soft-dark" id="id_number_ledger" name="id_number_ledger"
								value="<?= $data_sub_ledger->account_number ?>" disabled>
						</div>
					</div>
					<div class="mb-3">
						...
						<input type="text" id="nama_akun_subledger" name="nama_akun_subledger" data-parsley-required="true"
							...
							value="<?= $data_sub_ledger->name_coa ?>" class="form-control-hover-light form-control kapital"
					...
					<div class="mb-3">
						...
						<textarea name="deskripsi" id="deskripsi" data-parsley-required="true"
							...
							class="form-control-hover-light form-control" placeholder="input deskripsi"><?= $data_sub_ledger->des ?></textarea>
...
<script>
	$('#btnsubmit').click(function(e) {
		...
		if (form.parsley().isValid()) {
			$.ajax({
				url: "<?= base_url('C_chart_of_account/updateSubLedger') ?>",
				type: 'POST',
				method: 'POST',
				dataType: 'JSON',
