...
class Tcpdf_custom extends TCPDF
{
	...
	public function Header()
	{
		...
		$header = '
            ...
            <h5 style="text-align:center; margin:0;">ACCOUNT SUBLEDGER OVERVIEW</h5>
	...
	public function Footer()
	{
		...
		$footer = '
            <table width="100%" cellpadding="2" style="font-size:7px;">
                <tr>
                    <td style="text-align:center; color:#555;">© 2025 TVIP - Generated by System</td>
                </tr>
            </table>
        ';
